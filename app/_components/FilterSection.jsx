...
const FilterSection = ({setBathCount,setBedCount,setParkingCount,setHomeType}) => {
  return (
    <div className='px-3 py-4 grid grid-cols-2 md:flex gap-2'>
        ...
        <Select onValueChange={setBathCount}>
            ...
            <SelectContent>
                ...
                <SelectItem value="5">
                    <h2 className='flex gap-2'> <Bath className='h-5 w-5 text-primary'/>5+</h2>
                </SelectItem>
            </SelectContent>
        </Select>
        ...
        <Select onValueChange={(v) => v == 'All' ? setHomeType(null) : setHomeType(v)}>
            <SelectTrigger className="w-[180px]">
